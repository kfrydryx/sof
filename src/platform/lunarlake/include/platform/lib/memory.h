...
/* link DMAC stream */
#define GTW_LINK_OUT_STREAM_SIZE        0x00000040
#define GTW_LINK_OUT_STREAM_BASE(x) \
			(0x00079400 + x * GTW_LINK_OUT_STREAM_SIZE)

#define GTW_LINK_IN_STREAM_SIZE 0x00000040
#define GTW_LINK_IN_STREAM_BASE(x) \
			(0x00079800 + x * GTW_LINK_IN_STREAM_SIZE)
